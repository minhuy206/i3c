module bus_monitor_sva #(
  ...
  cp_valid_stop_reports_stop :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && stop_det_trigger
                  ##1 state_stop_det && !state_start_det && !state_rstart_det);

  ap_first_start_classified_as_start :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_first_start_classified_as_start :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && start_det && !rstart_detection_en
                  && state_start_det && !state_rstart_det);

  ap_first_start_enables_rstart_detection :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_start_candidate_requires_filtered_sda_high :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_negedge_i && !sda_r ##1 !start_candidate_q);

  ap_stop_candidate_requires_filtered_sda_low :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_stop_candidate_requires_filtered_sda_low :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_posedge_i && sda_r ##1 !stop_candidate_q);

  ap_start_candidate_requires_scl_stable_high :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_start_candidate_requires_scl_stable_high :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_negedge_i && !scl_high_at_sda_edge
                  ##1 !start_candidate_q);

  ap_stop_candidate_requires_scl_stable_high :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_stop_candidate_requires_scl_stable_high :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_posedge_i && !scl_high_at_sda_edge
                  ##1 !stop_candidate_q);

  ap_rejected_sda_falling_edge_no_start_trigger :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_rejected_sda_falling_edge_no_start_trigger :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_negedge && !start_candidate && !start_det_trigger);

  ap_rejected_sda_rising_edge_no_stop_trigger :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_rejected_sda_rising_edge_no_stop_trigger :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_posedge && !stop_candidate && !stop_det_trigger);

  ap_simultaneous_falling_edges_no_start_candidate :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
  ...
  cp_simultaneous_falling_edges_no_start_candidate :
  cover property (@(posedge clk_i) disable iff (!rst_ni)
                  enable_i && sda_negedge_i && scl_negedge_i ##1 !start_candidate_q);

  ap_simultaneous_rising_edges_no_stop_candidate :
  assert property (@(posedge clk_i) disable iff (!rst_ni)
