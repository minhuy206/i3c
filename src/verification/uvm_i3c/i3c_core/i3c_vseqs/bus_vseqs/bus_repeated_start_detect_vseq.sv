class bus_repeated_start_detect_vseq extends bus_base_vseq;
  `uvm_object_utils(bus_repeated_start_detect_vseq)

  function new(string name = "bus_repeated_start_detect_vseq");
    super.new(name);
  endfunction
