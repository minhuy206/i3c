class i3c_imm_data_nack_i2c_vseq extends i3c_base_vseq;
  ...
  virtual task run_data_nack_case(bit [2:0] dtt);
    ...
    `uvm_info(`gfn, $sformatf("ERR_004 dtt=%0d: I2C immediate write, address ACK, data NACK", dtt),
              UVM_MEDIUM)

    cfg = make_transfer_cfg(
        .ctxt($sformatf("ERR_004 dtt%0d", dtt)),
    ...
    read_response(resp);
    check_all_queues_empty($sformatf("ERR_004 after dtt=%0d", dtt));
