...
(FSM) remain as \texttt{TODO} stubs. Recent academic work on I3C has likewise concentrated on building a
UVM verification environment for the protocol rather than on a compact, studyable
controller~\cite{chauhan_i3c_uvm}. Chapter~3 explains the qualitative design boundary derived from this
