...
\section*{Quan sát trên bus (\IThreeCCoverage{})}
...
\section*{Tương quan đầu cuối (\CorrelatedCoverage{})}
...
\begin{longtable}{L{4.2cm} L{8.4cm}}
  ...
  \texttt{short\_boundary}       & Vị trí cắt của giao dịch đọc kết thúc sớm so với boundary \gls{dword}. \\
