...
Bố cục các thanh ghi điều khiển/trạng thái, cổng hàng đợi và bảng DAT phỏng theo mô hình thanh ghi của \gls{hci}~\cite{mipi_i3c_hci} như hiện thực trong thiết kế tham chiếu CHIPS Alliance~\cite{chipsalliance_i3c}, được rút gọn cho phạm vi khóa luận (còn \CsrRegisterCount{} thanh ghi, DAT \DatEntryWidth{}-bit thay cho 64-bit, lược bỏ DCT, \gls{ibi} và target-mode). Riêng khối thanh ghi định thời SCL/\iic{} cùng các giá trị mặc định là quyết định hiện thực nội bộ, không thuộc bản đồ HCI chuẩn.
