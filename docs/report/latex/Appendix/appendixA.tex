...
\begin{longtable}{L{4.6cm} C{2.0cm} L{6.4cm}}
  ...
  \midrule
  \endhead
  \texttt{HC\_CONTROL}    & 0x004 & Điều khiển bộ điều khiển (enable, i3c\_fsm\_en, phát \IThreeCBroadcastAddress{}, abort). \\
  \texttt{RESET\_CONTROL} & 0x010 & Reset mềm (sw\_reset) cho các khối và hàng đợi; chỉ có hiệu lực khi FSM ở Idle. \\
