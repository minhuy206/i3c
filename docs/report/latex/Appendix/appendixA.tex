...
\begin{longtable}{L{4.6cm} C{2.0cm} L{6.4cm}}
  ...
  \midrule
  \endhead
  \texttt{HC\_CONTROL}    & 0x004 & Điều khiển bộ điều khiển (enable, i3c\_fsm\_en, sw\_reset, phát \IThreeCBroadcastAddress{}, abort). \\
  ...
  \texttt{PIO\_DATA\_PORT} & 0x088 & Cổng ghi TX / đọc \RxFifo{}. \\
...
Mỗi mục DAT (\texttt{dat\_entry\_t}) rộng \DatEntryWidth{}-bit gồm: cờ \texttt{device} ở bit [31] (1 = thiết bị
\iic{} legacy), \DynamicAddress{} ở [22:16], và \StaticAddress{} ở [6:0]; các bit còn lại dự trữ.
