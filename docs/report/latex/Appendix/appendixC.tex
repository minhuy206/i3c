...
\begin{longtable}{C{1.2cm} L{4.2cm} L{7.2cm}}
  ...
  13 & \texttt{BusFree}          & Đợi \BusFreeCondition{} sau STOP. \\
  \bottomrule
\end{longtable}
...
\begin{figure}[!htbp]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \input{figures/scl_generator_fsm.tex}
  \end{adjustbox}
  \caption{Sơ đồ chuyển trạng thái của \SclGenerator{}, nhóm theo bốn chức năng.}
...
\begin{longtable}{C{1.2cm} L{4.2cm} L{7.2cm}}
  ...
  4 & \texttt{SendAddr}     & Phát \DynamicAddress{} kèm parity. \\
...
\begin{figure}[!htbp]
  \centering
  \begin{adjustbox}{max width=\textwidth}
    \input{figures/entdaa_fsm.tex}
  \end{adjustbox}
  \caption{Sơ đồ chuyển trạng thái của \EntdaaFsm{} cho một vòng cấp địa chỉ.}
