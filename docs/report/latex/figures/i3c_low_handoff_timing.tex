...
\begin{tikzpicture}[
  ...
  \draw[wave]
    (0,3.75) -- (1.05,3.75) -- (1.05,2.95)
    -- (4.65,2.95) -- (4.65,3.75) -- (10.40,3.75);

  % SDA driven by Controller: held LOW through SCL high and released at SCL falling.
  \draw[wave]
    (0,1.95) -- (2.20,1.95) -- (2.20,1.15)
    -- (7.10,1.15) -- (7.10,1.95) -- (10.40,1.95);
  ...
  \node[condlabel] at (4.65,6.32) {LOW HANDOFF};
  ...
  \pgfresetboundingbox
  \path[use as bounding box] (-5.10,-1.35) rectangle (14.40,6.65);
\end{tikzpicture}
\endgroup
