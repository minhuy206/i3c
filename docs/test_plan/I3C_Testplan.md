...
| I3C private write | SDRW_001..SDRW_006; broadcast-header enabled write framing is covered by CSR_003, SDRW_002, and SDRW_004; SDR write T-bit parity is SVA-covered and exercised by SDRW write payload traffic | `cp_dir`, `cp_data_len`, `cp_sdr_write_tbit_parity`, `cp_private_start_prefix` |
...
| ENTDAA | DAA_001..DAA_007, ERR_003, ERR_006, ERR_007 | `cp_daa_count`, `cp_daa_addr`, `cp_daa_result`, `cp_daa_pid`, `cp_daa_bcr`, `cp_daa_dcr`, `cp_daa_abort_point` |
...
| Broadcast-header private preamble | CSR_003, SDRW_002/004, SDRR_001..SDRR_007, ERR_005..ERR_008, I2C_003 | `cp_broadcast_addr_enable`, `cp_private_start_prefix`, `cp_first_address` |
